...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Jenkins CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Jenkins controllers
...
# This target prepares repo for your provider by replacing all "jenkins"
